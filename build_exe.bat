...
pyinstaller --onefile --noconsole --icon=icons/LlamaForge_32.png --add-data "templates;templates" --add-data "static;static" --add-data "icons;icons" --name "LlamaForge_BETA_V0.1a" app.py
