...
pyinstaller --onefile --noconsole --icon=LlamaForge.ico --add-data "templates;templates" --add-data "static;static" --add-data "icons;icons" --add-data "LlamaForge.ico;." --name "LlamaForge_BETA_V0.1a" app.py
