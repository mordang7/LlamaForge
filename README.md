...
1.  Download the latest `LlamaForge.exe` from the [Releases](https://github.com/mordang7/LlamaForge/releases) page.
2.  Place it in a folder (it creates a few config files).
...
[![Donate with PayPal](https://img.shields.io/badge/Donate-PayPal-blue.svg)](https://paypal.me/mordang7)
